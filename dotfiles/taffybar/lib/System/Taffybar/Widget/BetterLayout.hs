...
module System.Taffybar.Widget.BetterLayout
  (
  -- * Usage
  -- $usage
    LayoutConfig(..)
...
import           System.Taffybar.Widget.Layout (LayoutConfig(..), defaultLayoutConfig)
...
betterLayoutNew :: LayoutConfig -> TaffyIO Gtk.Widget
betterLayoutNew config = do
  ctx <- ask
